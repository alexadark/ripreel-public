...
/**
 * Webhook endpoint to receive Flux enhancement results from n8n
 *
 * Expected payload:
 * {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("📥 Received Flux enhancement result:", {
      scene_image_id,
      status,
      has_image: !!image_url,
    });
    ...
    // Update database with enhanced image
    await db
      .update(scene_images)
      .set({
    ...
    console.log("✅ Flux enhanced image updated in database");
